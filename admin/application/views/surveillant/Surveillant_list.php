...
<html>
    ...
    <body>
        ...
        <table class="table table-bordered" style="margin-bottom: 10px">
            <tr>
                <th>No</th>
		<th>NomSurveillant</th>
		<th>PrenomSurveillant</th>
		<th>TelephoneSurveillant</th>
		...
		<th>Action</th>
			...
			<td><?php echo $surveillant->passwordSurveillant ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('surveillant/read/'.$surveillant->idSurveillant),'Read'); 
				echo ' | '; 
				echo anchor(site_url('surveillant/update/'.$surveillant->idSurveillant),'Update'); 
				echo ' | '; 
				echo anchor(site_url('surveillant/delete/'.$surveillant->idSurveillant),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
