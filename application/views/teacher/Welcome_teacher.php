                                    ...
                                    <div class=" m-b-30">
                                        <div class="">
                                            <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#my-course" role="tab" aria-selected="true">Mes cours</a>
                                                </li>
                                                <li class="nav-item">
                                                                    ...
                                                                    <div class="">
                                                                        <table id="datatable2" class="table">
                                                                            ...
                                                                            <?php foreach($courses as $course) { ?>                                                                         <tr>
                                                                                ...
                                                                                <td> <?php echo $course->heureDebutCours ?></td>
                                                                                <td> <?php echo $course->heureFinCours ?> </td>
                                                                                <td></td>
                                                                            </tr>
                                                                            <?php } ?>
                                                                            </tbody>
                                                        ...
                                                        <div class="col-md-12 col-xl-12">
                                                            <div class="card m-b-30">
                                                                <div class="card-body">
                                                                    ...
                                                                    <p class="text-muted  font-14"> Votre cours sera valide par le directeur adjoint avant d'etre imputé dans le programme</p>
